...
class PairedLayer(nn.Module):
    def __init__(self, n_in, n_out=1, filters=(), ksize=(), fc_layers=(), dropout_rate=0.0, exclude_diag=True,
                 resnet=True):
    ...
    def __init__(self, embed_size=0,
        ...
        if num_transformer_layers == 0:
            self.encoder = CNNLSTMEncoder(n_in,
                                          ...
                                          dilation=dilation, num_att=num_att,
                                          num_lstm_layers=num_lstm_layers, num_lstm_units=num_lstm_units,
