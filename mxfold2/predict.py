...
class Predict:
    ...
    def run(self, args, conf=None):
        ...
        self.predict(output_bpseq=args.bpseq, output_bpp=args.bpp, result=args.result,
    ...
    def add_args(cls, parser):
        ...
        gparser.add_argument('--model', choices=('Turner', 'Zuker', 'ZukerS', 'ZukerL', 'ZukerC', 'Mix', 'MixC'),
                             default='Turner',
